...
-- This homework was worked on by Ryan Wallerius and Daniyal Abbas.
-- Ryan worked on the first four functions and Daniyal worked on the last 4 functions. 
...
isBST (Node x (Leaf l) (Leaf r))
	...
	| r < x		= False
	| otherwise	= True
isBST (Node x (Node l _ _) (Node r _ _))
	| l > x		= False
	| r < x		= False
	| otherwise	= True
